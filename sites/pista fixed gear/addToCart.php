	...
	echo "noMatch is: " . $noMatch . "<br/>"; //for troubleshooting
	 	...
	 	if ($item_qty > 0) {
		  ...
		  //INNER LOOP: LOOPING THROUGH CART FOR THIS PARTICULAR POST ITEM
			 ...
			 //for troubleshooting
			 echo "Already in cart:  Product id is $product_id_CART and SIZE id is $size_id_CART and COLOR id is $color_id_CART<br/>";
			 echo "On the post: Product id is $product_id_POST and SIZE id is $size_id_POST and COLOR id is $color_id_POST<br/>";
			 ...
			 if (($product_id_POST == $product_id_CART) && ($size_id_POST == $size_id_CART) && ($color_id_POST == $color_id_CART)) {
