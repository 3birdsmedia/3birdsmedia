          ...
          <html>
            <body>
              <table align='center' width='600' style='font-family:Myriad Pro, Helvetica, Arial; color:#F00;border:thin #ccc solid' bordercolor='#ccc' cellpadding='0' cellspacing='10'>
                ...
                <tr><td align='center' colspan='2' style='border-bottom:thin #ccc solid; color:#777;'><br/><h2>Welcome to the Apokaradokia Family</h2></td></tr>
                <tr><td style='color:#333'>Print this email as a friendly reminder of this important information. Thanks<br/></td></tr>
                <tr><td style='color:#333'>Email: $email </td></tr>
                <tr><td style='color:#333'>Password: $org_password </td></tr>
              </table>  
            </body>
          </html>";
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto col-12">
          <li class="nav-item col-12 hidden-lg-up">
            <a class="nav-link brand" href="#home"><span class="rev-logo-header">ARROW OF <strong>VICTORY</strong></span></a>
          </li>
...
?>
        ...
        <h2>Current Member (log In)</h2>         
            <?php if(isset($log_error)){
              echo '<p class="error contMsg">'.$log_error.'</p><br />';
                        //echo md5($password).'<br />';
                        //echo $savedPwd;
                   }else{?>
