...
editstyle = '../styles/wyzzstyles/editarea.css';

// Do we want to try to clean the code to emulate xhtml? 1=Yes, 0=No
xhtml_out = 0;

// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="../styles/wyzzstyles/style.css">\n');
...
var iframe = '<table id="editor" cellpadding="0" cellspacing="0" border="0" style="width:' + wyzzW + 'px; height:' + wyzzH + 'px;border: 1px inset #dddddd;"><tr><td valign="top">\n'
  ...
  if (browserName == "Microsoft Internet Explorer") {
      ...
      doc.write('<html><head><link rel="stylesheet" type="text/css" href="' + editstyle + '"/></head><body id="wyzz">' + content + '<br /></body></html>');
    }
  doc.close();
