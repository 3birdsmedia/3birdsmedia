...
jQuery(function(){
   jQuery("div.svwp").prepend("<img src='images/preload.gif' class='ldrgif' alt='loading...'/ >"); //change with YOUR loader image path   
});
var j = 0;
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			thumbsBorderWidth: 2,
			buttonsWidth: 25,
			galBorderColor: "#EC008B",
			thumbsBorderColor: "#EC008B",
			thumbsActiveBorderColor: "#EC0059",
			buttonsTextColor: "#EC008B",
