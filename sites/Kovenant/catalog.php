...
?>
  ...
  <section id="header" class="catalog-header">
        <h1>Catalog <span class="slash">/</span></h1>
  </section>

  <section id="action" class="content">
      <div class="catalog-front">

        <!--  -->
          <div class="row battle-tested">

              <H2 class="">"Battle Tested" Collection</H2>

              <div class="container">
                <div class="row">

                  <div class="col-sm-12 col-md-4">
                    <img src="images/catalog/battle-tested-1.jpg" alt="Battle Tested 1"/>
                  </div>
                  <div class="col-sm-12 col-md-4">
                    <img src="images/catalog/battle-tested-2.jpg" alt="Battle Tested 2"/>
                  </div>
                  <div class="col-sm-12 col-md-4">
                    <img src="images/catalog/battle-tested-4.jpg" alt="Battle Tested 3"/>
                  </div>
                  <div class="col-sm-12 col-md-4">
                    <img src="images/catalog/battle-tested-3.jpg" alt="Battle Tested 3"/>
                  </div>
                </div>
                </div>
          </div>
        ...
        <!--  -->
          <div class="row battle-tested">
              ...
              <H2 class="">"I AM" Collection</H2>

              <div class="container">
                <div class="row">

                <div class="col-sm-12 col-md-4">
                  <img src="images/catalog/iam-1.jpg" alt="I AM ______ 1"/>
                </div>
                <div class="col-sm-12 col-md-4">
                  <img src="images/catalog/iam-2.jpg" alt="I AM ______ 2"/>
                </div>
                <div class="col-sm-12 col-md-4">
                  <img src="images/catalog/iam-3.jpg" alt="I AM ______ 3"/>
                </div>
                <div class="col-sm-12 col-md-4">
                  <img src="images/catalog/iam-4.jpg" alt="I AM ______ 3"/>
                </div>
                <!--div class="col-sm-12 col-md-4">
                  <img src="images/catalog/iam-5.jpg" alt="I AM ______ 3"/>
                </div-->
                <div class="col-sm-12 col-md-4 ">
                  <img src="images/catalog/iam-6.jpg" alt="I AM ______ 3"/>
                  <!--hs-wrapper<img src="images/catalog/iam-6-on1.jpg" alt="I AM ______ 3"/>
                  <img src="images/catalog/iam-6-on2.jpg" alt="I AM ______ 3"/>
                  <img src="images/catalog/iam-6-on3.jpg" alt="I AM ______ 3"/>
                  <img src="images/catalog/iam-6-on4.jpg" alt="I AM ______ 3"/>
                  <img src="images/catalog/iam-6-on5.jpg" alt="I AM ______ 3"/>
                  <img src="images/catalog/iam-6-on6.jpg" alt="I AM ______ 3"/>-->
                </div>
            </div>
            </div>
          </div>
        ...
        <!--  -->
          <div class="row battle-tested">
              ...
              <H2 class="">"Warrior" Collection</H2>

              <div class="container">
                <div class="row">

                  <div class="col-sm-12 col-md-4">
                    <img src="images/catalog/kw-1.jpg" alt="Kindom Warrior 1"/>
                  </div>
                  <div class="col-sm-12 col-md-4">
                    <img src="images/catalog/kw-2.jpg" alt="Kindom Warrior 2"/>
                  </div>
              </div>
              </div>
          </div>
