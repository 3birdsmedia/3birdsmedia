      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto col-12">
          <li class="nav-item col-4 hidden-lg-up">
            <a class="nav-link brand" href="index.php">REV<strong>LOVE</strong></a>
          </li>
          ...
          <li class="nav-item col-4 hidden-md-down">
            <a class="nav-link brand" href="index.php"><span class="rev-logo-header">REV<strong>LOVE</strong></span></a>
          </li>
          <li class="nav-item col-2">
            <a class="nav-link" href="#tribe">The Tribe</a>
          </li>
          <li class="nav-item col-2">
