...
?>
  ...
  <section id="header" class="about-header">
        <h1>About <span class="slash">/</span></h1>
  </section>
      ...
      <div class="bio">
        ...
        <!--  -->
          <div class="row">
              ...
              <H2 class="col-sm-12 ">- Armor of Light -</H2>
                  <div class="col-sm-12 ">
                   <p>
                     Kovenant Clothing isn't trying to sugar-coat this life of warfare; battles of light and dark, good and evil, love and hate, life and death. We are a faith-based clothing company whose goal is to create unique lifestyle clothing that inspires strength, hope, and perseverance in the diverse people who wear it. We walk through this darkness prepared and ready to fight death with life because the dawn is soon approaching. We work with faith-based companies and churches as well to support others in their pursuit to spread light.
                   </p>
                </div>
                </div>
          </div>
