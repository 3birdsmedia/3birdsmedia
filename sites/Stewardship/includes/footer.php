...
$currentPage = basename($_SERVER['SCRIPT_NAME']); ?>
  ...
  <section id="footer" class="text-center">
    ...
    <div class="container">
      <div class="box box1 apokaradokia"><a target="_blank" href="http://www.apokaradokiallc.com"><div class="inner"> Apokaradokia</div></a></div>
    ...
    <div class="container">
      <a href="https://www.facebook.com/Apokaradokia-510663765959355/" target="_blank" class="btn fb_btn">Follow Apokaradokia on <i class="fa fa-facebook-square" aria-hidden="true"></i></a>
    </div>

    <span id="siteseal"><script async type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=t1rhA91TiPTiEA8m5n8tTHxbVMMV8dYiLUvJAZsezLWeZjIWq76dFZYDsXLT"></script></span>
  </section>  