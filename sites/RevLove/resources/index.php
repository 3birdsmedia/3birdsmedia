...
<style id="badge-styles">
 ...
 .vimeoBadge a, .vimeoBadge a:link, .vimeoBadge a:visited, .vimeoBadge a:active { color: #777; text-decoration: none; cursor: pointer; font-size: 1.2em; letter-spacing: 0;line-height: 0.9}
 ...
 .vimeoBadge .caption {overflow:hidden; width: auto; height: 60px; }
...
<script src="https://vimeo.com/apokaradokia/badgeo/?script=1&badge_layout=horizontal&badge_quantity=30&badge_size=200&badge_stream=album&show_titles=yes&badge_album=4725418"></script>
</div>
</div>
          </div>
