...
<?php include_once("../includes/analyticstracking.php") ?>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>RevLove - Bookkeeping</title>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto col-12">
          <li class="nav-item col-4 hidden-lg-up">
            <a class="nav-link brand" href="../index.php#home">REV<strong>LOVE</strong></a>
          </li>
          <li class="nav-item col-md-2 col-sm-12">
            <a class="nav-link" href="../index.php#mission">Our Mission</a>
          </li>
          <li class="nav-item col-md-2 col-sm-12">
            <a class="nav-link" href="../index.php#services">Services</a>
          </li>
          <li class="nav-item col-4 hidden-md-down">
            <a class="nav-link brand" href="../index.php#home"><span class="rev-logo-header">REV<strong>LOVE</strong></span></a>
          </li>
          <li class="nav-item col-md-2 col-sm-12">
          ...
          <li class="nav-item col-md-2 col-sm-12">
            ...
            <ul class="dropdown-menu">
              <li class="nav-item col-md-12 col-sm-12">
                <a class="nav-link" href="../index.php#tribe">Our Tribe</a>
              </li>
              <li class="nav-item col-md-12 col-sm-12">
      ...
      <div class="row">
        ...
        <div class="container">
          ...
          <div class="col-sm-12 col-md-5">
            <a href="https://quickbooks.intuit.com/"><image src="../images/logo-quickbooks-large.svg" class="responsive" alt="Quickbooks Logo" /></a>
          </div>
          <div class="col-sm-12 col-md-7">
          <p>In an effort to provide our members with accurate and up-to-date monthly bookkeeping, which supports our tax strategies, budget assistance and financial stewardship philosophy, we rely on and trust “Intuit –Quickbooks”. Quickbooks allows us to reconcile not only our company financials but also your business expenses from your bank accounts, credit cards and savings accounts, provide you with a monthly Profit and Loss statement to understand where your income is going and track spending. You’ll continue to feel safe, secure and financially organized knowing Quickbooks is taking great care of you and your family month over month.</p>
</div>
          </div>
        <!-- BEGIN: Constant Contact Email List Form Button -->
        <div align="center">
        <a href="https://visitor.r20.constantcontact.com/d.jsp?llr=jolwu7zab&amp;p=oi&amp;m=1127316401609&amp;sit=v6gqqdklb&amp;f=62bc5004-6799-4118-aa62-0f2eaeadfca2" class="button" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(91, 91, 91); color: #31c0cc; display: inline-block; padding: 0.5EM 1EM; text-shadow: none; border-radius: 10px;font-size: 1.5em; margin: 20px auto 20px;">SIGN UP FOR UPDATES</a>
