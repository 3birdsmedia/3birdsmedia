...
<style id="badge-styles">
 ...
 .vimeoBadge .s360 img { border: 0; width: 100%;max-width: 200px;}
 .vimeoBadge img { border: 0;}
 .vimeoBadge a, .vimeoBadge a:link, .vimeoBadge a:visited, .vimeoBadge a:active { color: #777; text-decoration: none; cursor: pointer; font-size: 1.2em; letter-spacing: 0;
    line-height: 1.2;
    padding-top: 10px;
    display: block;}
 ...
 .vimeoBadge .s360 { width: 360px; }
 </style><div id="badge">
<div class="vimeoBadge horizontal">
<script src="https://vimeo.com/apokaradokia/badgeo/?script=1&badge_layout=horizontal&badge_quantity=30&badge_size=360&badge_stream=album&show_titles=yes&badge_album=4814015"></script>
</div>
</div>
          </div>
